/* 🧠 다마AI: 음식 한글 표시 이름 — 데이터 키는 세이브 호환을 위해 그대로 두고, 화면에만 한글 */
const KO_FOOD = {
    "bread": "빵",
    "pizza": "피자",
    "hamburger": "햄버거",
    ...
    "sushi": "초밥",
    "sushi set": "초밥 세트",
    "sunny savory soup": "햇살 수프",
    "crabstew": "게 스튜",
    "spicy dragon pot": "매운 용 전골",
    "fish dish": "생선 요리",
    "forest fungi stew": "숲 버섯 스튜",
    "star nuggies": "별 너겟",
    "tacos": "타코",
    "sambooseh": "사모사",
    "pie": "파이",
    ...
    "spaghetti": "스파게티",
    "telesushi": "텔레초밥",
    "s-special dish": "스페셜 요리",
    "bunny burger": "토끼 버거",
    "pancakes": "팬케이크",
    "dumplings": "만두",
    "mushroom soup": "버섯 수프",
    "oyster seafood": "굴 해물",
    "butter steak": "버터 스테이크",
    "stuffed pumpkin": "속찬 호박",
    "sky bread": "하늘빵",
    "veggie burger": "야채 버거",
    "puzzlewich": "퍼즐 샌드위치",
    "lunchbox": "도시락",
    "veggies roll": "야채 롤",
    "veggies basket": "야채 바구니",
    "veggies stew": "야채 스튜",
    "stir veggies": "야채 볶음",
    "melodywich": "멜로디 샌드위치",
    "veggies curry": "야채 카레",
    ...
    "rice ball": "주먹밥",
    "hot pot": "전골",
    "lovely salad": "러블리 샐러드",
    "fresh salad": "신선 샐러드",
    "vegetables cut": "야채 스틱",
    "roasted sweet potatoes": "군고구마",
    "sweet rainbow": "무지개 사탕",
    "koluche": "콜루체",
    "jelly": "젤리",
    "chocolate pie": "초코 파이",
    "lollipop": "막대사탕",
    "vanilla icecream": "바닐라 아이스크림",
    "strawberry icecream": "딸기 아이스크림",
    "scoped icecream": "스쿱 아이스크림",
    "snacks and bits": "과자 모둠",
    "lemonade": "레모네이드",
    "cupcake": "컵케이크",
    "cappuccino": "카푸치노",
    "strawberry donut": "딸기 도넛",
    "choco cake slice": "초코 케이크",
    "cotton candy": "솜사탕",
    "cream icepack": "크림 아이스",
    "bunny mooko": "토끼 모코",
    "paloodeh": "팔루데",
    "toasted marshmallows": "구운 마시멜로",
    "watermelon": "수박",
    "orange juice": "오렌지 주스",
    "snackfin": "스낵핀",
    "banana": "바나나",
    ...
    "kuchice": "쿠치체",
    "spookandy": "유령 사탕",
    "strawberry pie": "딸기 파이",
    "rainbow cake": "무지개 케이크",
    "takoyaki": "타코야키",
    "broccoli": "브로콜리",
    "milk": "우유",
    "sleep replacement": "잠 보충제",
    "appetite stim": "식욕 촉진제",
    "medicine": "약",
    "expression skill potion": "표현력 물약",
    "logic skill potion": "논리력 물약",
    "endurance skill potion": "체력 물약",
    "potion of neglect": "방치의 물약",
    "potion of well behaving": "착한 아이 물약",
    "potion of misbehaving": "말썽꾸러기 물약",
    "potion of fulfillment": "포만감의 물약",
    "potion of aging up": "성장의 물약",
    "potion of nothingness": "무(無)의 물약",
    "life essence": "생명의 정수"
};
function koFood(n) { return KO_FOOD[n] || String(n).toUpperCase(); }
...
App.definitions = (() => {
    ...
    return  {
        ...
        main_menu: [
            {
                /* 🧠 다마AI: AI 메뉴가 1번 — 이 게임의 정체성 */
                id: 'ai',
                name: '<i class="fa-solid fa-brain"></i>',
                onclick: () => {
            ...
            {
                /* 🧠 다마AI: 잠을 메인 메뉴로 승격 (돌봄 메뉴에서 꺼냄) */
                id: 'sleep',
                name: '<i class="fa-solid fa-moon"></i>',
                onclick: () => {
                    App.handlers.sleep();
                }
            },
            /* 🧠 다마AI: "AI 공부가 게임의 유일한 엔진" — 학습과 무관한 메뉴 숨김.
               돌봄(미션·훈육·뒷마당)·외출(쇼핑몰 등 11곳)·소지품·폰(온라인, 차단됨).
               필요하면 아래 주석을 풀어 복원한다.
            {
                id: 'care',
